    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="group flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-primary/10 text-primary shadow-sm transition-transform duration-300 group-hover:-translate-y-0.5">
                <span className="font-heading text-sm font-semibold">VB</span>
              </div>
              <span className="font-semibold uppercase tracking-[0.2em] text-subtext text-xs">Vishant Bhardwaj</span>
            </Link>
            ...
            <div className="flex items-center gap-3">
              <Button asChild variant="outline" size="sm" className="rounded-xl border border-border bg-surface/80 text-subtext hover:bg-surface hover:text-text">
                <a href="/images/vishantbhardwajresume.pdf" download="Vishant_Bhardwaj_CV.pdf">
      ...
      <div className="flex-1 flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] p-4">
        <motion.div
          ...
          className="w-full max-w-6xl h-full max-h-[calc(100vh-10rem)] bg-surface rounded-2xl shadow-2xl overflow-hidden border border-border/50 flex flex-col"
        >
          {/* PDF Content */}
          <div className="flex-1 overflow-auto p-4">
            ...
            {!error && (
              <div className="flex justify-center">
                <iframe
                  src={`/images/vishantbhardwajresume.pdf#toolbar=1&navpanes=0&scrollbar=1&view=FitH`}
